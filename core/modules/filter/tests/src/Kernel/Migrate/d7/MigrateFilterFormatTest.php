...
class MigrateFilterFormatTest extends MigrateDrupal7TestBase implements MigrateDumpAlterInterface {
  ...
  public function testFilterFormat() {
    $this->assertEntity('custom_text_format', 'Custom Text format', ['filter_html' => -10, 'filter_autop' => 0], 0, TRUE);
    $this->assertEntity('filtered_html', 'Filtered HTML', ['filter_url' => 0, 'filter_html' => 1, 'filter_autop' => 2, 'filter_htmlcorrector' => 10], 0, TRUE);
    $this->assertEntity('full_html', 'Full HTML', ['filter_url' => 0, 'filter_autop' => 1, 'filter_htmlcorrector' => 10], 1, TRUE);
