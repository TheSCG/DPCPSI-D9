...
function PrintThisPage(obj) {
    ...
    var sPage = sPath.substring(sPath.lastIndexOf('/') + 1);
     ...
     sOption += "scrollbars=yes,align=center,width=780px,height=700px";
	...
	winprint.document.write('<html><head><link href="'+pathToTheme+'/css/style.css"  rel="stylesheet" media="all" type="text/css" />');
	winprint.document.write('<html><head><link href="'+pathToTheme+'/css/sub.css"  rel="stylesheet" media="all" type="text/css" />');
	...
	winprint.document.write('<center><IMG width="750px" height="106px" SRC="'+pathToTheme+'/images/header_printbg.jpg" /></center>');
	winprint.document.write('</span>');
    winprint.document.write('</br></br></br><div style="font-family:Arial, Helvetica, sans-serif; color: #4a4b4f;font-size: 12px;font-weight: normal;line-height: 16px; margin:0; padding:0">' + sWinHTML + '</div>\r\n');
